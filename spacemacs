...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(base16-mocha
                         spacemacs-dark
                         spacemacs-light)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; Take the PATH variable form a NON-interactive shell (removes -i)
...
before packages are loaded."
  ...
  ;; Automatically clean up some buffers
  ...
  ;; Keep parentheses balanced in evilified lisp buffers
